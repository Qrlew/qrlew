...
mod tests {
    ...
    #[test]
    fn test_retail_with_admin_cols_with_pup_queries() {
        let retail_transactions: Relation = Relation::table()
            .name("retail_transactions")
            .schema(
                vec![
                    ...
                    ("sarus_weight", DataType::float_min(0.0)),
        ...
        let retail_demographics: Relation = Relation::table()
            ...
            .schema(
                vec![
                    ...
                    ("household_comp", DataType::text(), None),
                    ("kids_count", DataType::integer(), None),
                    ("sarus_privacy_unit", DataType::optional(DataType::id()), Some(Constraint::Unique)),
                    ("sarus_weight", DataType::float_min(0.0), None),
        ...
        for query_str in pup_queries {
            ...
            let dp_event = pup_relation.dp_event();
            println!("DP EVENT: {:?}", dp_event);
