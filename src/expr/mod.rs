...
impl_unary_function_constructors!(Opposite, Not, Exp, Ln, Log, Abs, Sin, Cos, Sqrt, CastToBoolean, CastToBytes, CastToInteger, CastToFloat, CastToText, CastToDate, CastToTime, CastToDateTime); // TODO Complete that
